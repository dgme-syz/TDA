...
@dataclass
class LoraMoEConfig(PeftConfig):
    """
    ...
    """
    top_k: int = field(default=2, metadata={"help": "Top k for LoRA"})
    num_tasks: int = field(default=2, metadata={"help": "Number of tasks for LoRA"})
