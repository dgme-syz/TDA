...
from .layer import LoraMoELayer, dispatch_default
...
class LoraMoEModel(BaseTuner):
    ...
    **Attributes**:
    ...
    def _check_new_adapter_config(self, config: LoraMoEConfig) -> None:
        """
    ...
    def _prepare_model(self, peft_config: LoraMoEConfig, model: nn.Module):
        r"""
    ...
    def _enable_peft_forward_hooks(self, *args, **kwargs):
        ...
        for layer in self.modules():
            if isinstance(layer, LoraMoELayer):
        ...
        for module in self.modules():
            if isinstance(module, LoraMoELayer) or isinstance(module, AuxiliaryTrainingWrapper):
